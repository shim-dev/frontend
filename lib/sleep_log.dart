...
//       title: Row(
//         children: [
//           Icon(Icons.nightlight_round, color: Color(0xD80A8356)),
//           SizedBox(width: 8),
//           Flexible(
//             child: Text(
//               "잠은 잘 자고 있나요?",
...
//       content: SizedBox(
//         width: 280,
//         height: 150, // 게이지 높이에 따라 조절
//         child: Stack(
//           alignment: Alignment.center,
//           children: [
//             // 게이지
//             Positioned(
//               top: 24, // arc를 위로 올릴수록 숫자도 함께 올라감
//               left: 0,
//               right: 0,
//               child: SizedBox(
//                 height: 120, // arc 높이 조절
//                 child: SleepGauge(
//                   value: sleepHours,
//                   max: 12,
//                   onChanged: (v) {
...
//             // 텍스트 (arc 중앙에)
//             Positioned(
//               top: 120, // arc 높이에 따라 조정, arc 중심부에 맞춰 조절
//               left: 0,
//               right: 0,
//               child: Center(
//                 child: Text(
...
//             backgroundColor: Color(0xD80A8356),
...
//
//   @override
//   State<SleepGauge> createState() => _SleepGaugeState();
// }
//
...
//     double value = widget.max * percent;
//     if (value < 0) value = 0;
//     if (value > widget.max) value = widget.max;
//     widget.onChanged(double.parse(value.toStringAsFixed(1))); // 0.1단위
//   }
//
//   @override
//   Widget build(BuildContext context) {
...
//             painter: _GaugePainter(widget.value, widget.max),
//             child: Container(), // 자식에 위젯 넣으려면 여기!
//           ),
//         );
//       },
//     );
...
//   final double max;
//
//   _GaugePainter(this.value, this.max);
//
//   @override
//   void paint(Canvas canvas, Size size) {
//     final double strokeWidth = 18.0;
//     final double arcPadding = strokeWidth / 2 + 8; // 패딩 추가
...
//         Paint()
//           ..color = const Color(0xD80A8356)
//           ..style = PaintingStyle.stroke
//           ..strokeWidth = strokeWidth
//           ..strokeCap = StrokeCap.round;
//     final double sweep = (value / max) * pi;
//     if (value > 0) {
...
//       shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(24)),
//       title: Row(
//         mainAxisAlignment: MainAxisAlignment.center, // ✅ 이름 붙여서!
...
//                       color: Color(0xD80A8356),
//                       fontWeight: FontWeight.bold,
//                       decoration: TextDecoration.underline, // 클릭 가능하게 밑줄!
//                     ),
//                   ),
//                 ),
//               ),
