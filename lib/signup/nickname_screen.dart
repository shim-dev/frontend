...
//                             : const AssetImage('assets/icon/turtle.png')
//                                 as ImageProvider,
//                   ),
//                   Positioned(
//                     bottom: 0,
...
//                     try {
//                       print("닉네임 서버 전송 시작");
//                       final result = await setNickname(
//                         widget.userId,
//                         nickname,
//                         imageUrl,
//                       );
...
//                           MaterialPageRoute(
//                             builder:
//                                 (context) => BirthScreen(userId: widget.userId),
//                           ),
//                         );
//                       } else {
//                         setState(() {
              ...
              child: DecoratedBox(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    ...
                    if (_profileImage != null) {
                      print("이미지 업로드 시작");
                      imageUrl = await uploadProfileImageToFirebase(
                        _profileImage!,
                        widget.userId,
                      );
                      print("업로드된 이미지 URL: $imageUrl");
