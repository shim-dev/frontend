...
class _SignupScreenState extends State<SignupScreen> {
  ...
  void _validateEmail() {
    ...
    if (_emailIdController.text.isEmpty) {
      ...
      r"^[a-zA-Z0-9._%+-]+$",
    ).hasMatch(_emailIdController.text.trim())) {
      _emailError = '이메일 아이디 형식이 올바르지 않습니다.';
    } else if (_selectedDomain == '직접 입력' &&
        !_customDomainController.text.contains('.')) {
