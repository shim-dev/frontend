...
//
// class SearchResultScreenDin extends StatefulWidget {
//   final List<Map<String, dynamic>> results;
//
//   const SearchResultScreenDin({super.key, required this.results});
//
//   @override
//   State<SearchResultScreenDin> createState() => _SearchResultScreenDinState();
// }
//
// class _SearchResultScreenDinState extends State<SearchResultScreenDin> {
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: Center(
                                            child: SvgPicture.asset(
                                              'assets/icon/dinner.svg', // 저녁용 아이콘 (svg 준비 시 경로 맞춰서!)
                                              width: 22,
                                              height: 22,
                                              colorFilter: ColorFilter.mode(
                                                Colors.white,
