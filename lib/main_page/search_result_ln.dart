...
class SearchResultScreenLn extends StatefulWidget {
  final List<Map<String, dynamic>> results;
  final Future<void> Function()? onScoreChanged;
  const SearchResultScreenLn({
    super.key,
  ...
  @override
  State<SearchResultScreenLn> createState() => _SearchResultScreenLnState();
}

class _SearchResultScreenLnState extends State<SearchResultScreenLn> {
                                        ...
                                        Container(
                                          ...
                                          child: Center(
                                            child: SvgPicture.asset(
                                              'assets/icon/lunch.svg', // 점심용 아이콘 (svg 준비 시 경로 맞춰서!)
                                              width: 22,
                                              height: 22,
